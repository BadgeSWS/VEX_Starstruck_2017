...
static const int ENCODER_RIGHT_TOP = 2;
static const int ENCODER_RIGHT_BOT = 3;

static const int GYRO = 4;

static const int POT_LEFT = 5;
static const int POT_RIGHT = 6;

static const int MOTOR_CLAW_LEFT = 4;
